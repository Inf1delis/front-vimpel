...
export const advantages = [
  {
    ...
    title: 'Качество',
    text: 'Наш бетон прочнее бетона конкурентов. Мы не добавляем сомнительные\n' +
  ...
  },
  {
    ...
    title: 'Нам доверяют',
    text: 'Огромный оборот: более 8 тысяч кубов за месяц выезжает с нашего\n' +
        '                    предприятия.'
  },
  {
    imgClass: 'fa fa-cubes',
    title: 'Электронный контроль',
    text: 'Вам приедет в точности заказанная кубатура.'
  }
];
